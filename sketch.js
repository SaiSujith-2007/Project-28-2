...
launcherObj=new launcher(stoneObj.body,{x:150, y:590});
tree1=createSprite(600,500,100,100);
tree1.addImage(tree_Image);
tree1.scale=0.5;
	Engine.run(engine);
...
function keyPressed(){
  if (keyCode===32){
    Matter.Body.setPosition(stoneObj.body, {x:150, y:590});
